...
<div class="content">
    <h4 class="text-center" style="font-family: Arial, sans-serif; font-weight: bold;">Reporte de los Operarios</h4><br>
            <table class="table table-sm table-striped table-bordered">
                <thead class="thead-dark text-center">
                    <tr>
                        <th colspan="5">Datos de los Operarios</th>
                    </tr>
                </thead>
                <tbody>
                    <tr class="text-center">
                        ...
                        <th style="font-weight: bold;">Vehículos</th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $persona->placas_vehiculos }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
